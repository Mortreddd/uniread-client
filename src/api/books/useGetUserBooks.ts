...
export default function useGetUserBooks(userId: undefined | string, pageNo?: number, pageSize?: number, query?: string) {
        ...
        async function getUserBooks() {
            ...
            api.get(`/authors/${userId}/books`, {
                ...
                .then((response: AxiosResponse<Paginate<Book[]>>) => {
                    ...
                    setState({ loading : false, data : null, error : error?.response?.data.message ?? "Unable to load books"})
                })
