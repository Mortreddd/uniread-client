...
import { AuthorDetail as AuthorDetailType } from "@/types/User.ts";
...
function AuthorDetail({ user, onUnfollow, onFollow }: AuthorDetailProps) {
          ...
          <div className="w-full px-5 mt-2 flex justify-center">
            {user.isFollowing ? (
              <Button
                ...
                className={
                  "flex gap-1 items-center justify-center rounded-sm w-full"
                }
              >
