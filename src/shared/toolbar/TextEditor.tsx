  ...
  switch (element.type) {
    case "h1":
      return (
        <h1
          {...attributes}
          className={cn("text-3xl font-bold", alignmentClass())}
        >
          {children}
        </h1>
      );
    case "h2":
      return (
        <h2
          {...attributes}
          className={cn("text-2xl font-bold", alignmentClass())}
        >
          {children}
        </h2>
      );
    case "h3":
      return (
        <h3
          {...attributes}
          className={cn("text-xl font-bold", alignmentClass())}
        >
          {children}
        </h3>
      );
  ...
  return (
    <Slate editor={editor} initialValue={values} onChange={onSlateChange}>
      ...
      <Editable
        ...
        className={`${className} p-2 text-gray-900 dark:text-gray-100 focus:ring-1 focus:ring-primary dark:focus:ring-primary-dark focus:outline-hidden border transition-all duration-200 ease-in-out border-primary dark:border-primary-dark rounded-sm`}
